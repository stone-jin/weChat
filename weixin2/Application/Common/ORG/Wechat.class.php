...
class Wechat {
	...
	/**
	 * 初始化
	 * @author stone-jin <1520006273@qq.com>
	 */
	...
	public function valid() {
		...
		if (isset($echoStr)) {
			...
			/* BEGIN: modify by stone-jin,2015-4-11 for 任何适合都需要退出*/
			exit();
			/* END: modify by stone-jin,2015-4-11 for 任何适合都需要退出*/
		} else {
			/* BEGIN: modify by stone-jin,2015-4-11 for 将错误返回到外面处理*/
			if(!$this->checkSignature()){
				return false;
			}
			/* END: modify by stone-jin,2015-4-11 for 将错误返回到外面处理*/
		}
		return true;
	}
	...
	public function request(){
		...
		if (!empty($postStr)) {
			...
			/* BEGIN:Modified by stone-jin,2015-4-11 for 返回值不对 */
			$this->data = $data;
			return $this->data;
			/* END:Modified by stone-jin,2015-4-11 for 返回值不对 */
		}else {
			return null;
		}
	}
